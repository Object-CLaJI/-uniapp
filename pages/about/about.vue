<template>
	<view class="about">
		<view class="content">
			<view class="qrcode">
				<image src="/uni_modules/uni-upgrade-center-app/images/bg_top.png" @longtap="save"></image>
				<h1 class="tip" style="color: red;">马版uniapp-作者killer</h1>
			</view>
			<view class="desc">
				<text class="code">uni-app</text>
				是一个使用 <text class="code">Vue.js</text> 开发跨平台应用的<text class="code">垃圾</text>前端框架。
			</view>
			<view class="source">
				...
				<view class="source-list">
					<view class="source-cell">
						...
						<text>下载 个锤子，新建 uni-app 项目时选择 <text class="code">Hello uni-app</text> 模板。</text>
					</view>
					<video style="height:200px;width: 300px;">
						<source src="/pages/about/QQ20221014-162643-HD.mp4" type="video/mp4">
					</video>
					<view class="source-cell">
						<text space="nbsp">2. </text>
						<u-link class="link" :href="'https://www.cnm.ninesleeves.online/'" :text="'https://www.cnm.ninesleeves.online/'"></u-link>
					</view>
				</view>
